...
-- setup haskell-tools configuration
...
-- haskell settings
--
--local ht_on_attach = function(_, bufnr, _)
--  -- NOTE: Remember that lua is a real programming language, and as such it is possible
--  -- to define small helper and utility functions so you don't have to repeat yourself
--  -- many times.
--  --
  ...
  hls = {
    on_attach =
        function(_, bufnr, ht)
          ...
          vim.keymap.set('n', '<leader>ca', vim.lsp.codelens.run, { buffer = bufnr })
          -- Hoogle search for the type signature of the definition under the cursor
          vim.keymap.set('n', '<leader>hs', ht.hoogle.hoogle_signature, { buffer = bufnr })
          -- Evaluate all code snippets
          vim.keymap.set('n', '<leader>ea', ht.lsp.buf_eval_all, { buffer = bufnr })
          -- Toggle a GHCi repl for the current package
          vim.keymap.set('n', '<leader>rr', ht.repl.toggle, { buffer = bufnr })
